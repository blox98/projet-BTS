...
void CIhmLampadaire::on_pReset_clicked()
{
    QMessageBox::StandardButton reply;
      ...
      if (reply == QMessageBox::Yes) {
        ...
        ui->LineDl->setText("");
        ui->LineNi->setText("");
        ui->txtConsole->setText("Restauration des paramètres par défaut");
